...
import FluxUiContextKeeperConfigs
  from '../../../../flux-ui-context-keeper/Adapters/Api/FluxUiContextKeeperConfigs.mjs';
...
export default class Aggregate {
  ...
  async #applyContextInitialized(event) {
    ...
    this.#components[event.contextId] = ApiClass.create(FluxUiContextKeeperConfigs.create(event.contextId));
