...
namespace KPG\Learnplaces\Setup\Migrations;
...
class LearnplacesResourceStorageMigrationVideos implements Migration
{
    ...
    {
        return "Learnplaces Videos ResourceStorage Migration";
    }
    ...
    public function step(Environment $environment): void
    {
        ...
        $db->manipulateF(
            "UPDATE xsrl_video_block SET resource_id = %s WHERE pk_id = %s",
            ['text', 'integer'],
