...
class PictureBlockRepositoryImpl implements PictureBlockRepository
{
    ...
    public function findByBlockId(int $id): PictureBlock
    {
        try {
            ...
            $pictureBlock = \KPG\Learnplaces\persistence\entity\PictureBlock::where(['fk_block_id' => $id])->first();
    ...
    public function findByLearnplace(Learnplace $learnplace): array
    {
         ...
         * @var Block[] $blocks
         */
        $blocks = Block::innerjoinAR(new \KPG\Learnplaces\persistence\entity\PictureBlock(), 'pk_id', 'fk_block_id')
        ...
        foreach ($blocks as $block) {
            $pictureBlock = \KPG\Learnplaces\persistence\entity\PictureBlock::where(['fk_block_id' => $block->getPkId()])->first();
    ...
    private function mapToDTO(Block $block, \KPG\Learnplaces\persistence\entity\PictureBlock $pictureBlockEntity): PictureBlock
    {
    ...
    private function mapToEntity(PictureBlock $pictureBlock): \KPG\Learnplaces\persistence\entity\PictureBlock
    {

        /**
         * @var \KPG\Learnplaces\persistence\entity\PictureBlock $activeRecord
         */
        $activeRecord = \KPG\Learnplaces\persistence\entity\PictureBlock::where(['fk_block_id' => $pictureBlock->getId()])->first();

        if(is_null($activeRecord)) {
            $activeRecord = new \KPG\Learnplaces\persistence\entity\PictureBlock();
