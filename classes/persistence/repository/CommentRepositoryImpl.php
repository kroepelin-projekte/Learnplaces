...
class CommentRepositoryImpl implements CommentRepository
{
    ...
    {
        try {
            $commentEntity = \KPG\Learnplaces\persistence\entity\Comment::findOrFail($id);
    ...
    {
        $commentBlocks = \KPG\Learnplaces\persistence\entity\Comment::where(['fk_comment_block' => $id])->get();
        return array_map(
            function (\KPG\Learnplaces\persistence\entity\Comment $comment) { return $this->mapToDTO($comment); },
            $commentBlocks
        );
    }
    ...
    public function delete(int $id)
    {
        try {
            /**
             * @var \KPG\Learnplaces\persistence\entity\Comment $commentEntity
             */
            $commentEntity = \KPG\Learnplaces\persistence\entity\Comment::findOrFail($id);
    ...
    private function mapToDTO(\KPG\Learnplaces\persistence\entity\Comment $commentEntity): Comment
    {
    ...
    private function mapToEntity(Comment $comment): \KPG\Learnplaces\persistence\entity\Comment
    {

        /**
         * @var \KPG\Learnplaces\persistence\entity\Comment $activeRecord
         */
        $activeRecord = new \KPG\Learnplaces\persistence\entity\Comment($comment->getId());
