...
class CommentBlockRepositoryImpl implements CommentBlockRepository
{
    ...
    {
        try {
            $block = \KPG\Learnplaces\persistence\entity\CommentBlock::findOrFail($id);
            return $this->mapToDTO($block);
    ...
    {
        try {
            $commentBlock = \KPG\Learnplaces\persistence\entity\CommentBlock::where(['fk_block_id' => $id])->first();
    ...
    public function findByLearnplace(Learnplace $learnplace): array
    {
         ...
         * @var Block[] $blocks
         */
        $blocks = Block::innerjoinAR(new \KPG\Learnplaces\persistence\entity\CommentBlock(), 'pk_id', 'fk_block_id')
    ...
    private function mapToEntity(CommentBlock $commentBlock): \KPG\Learnplaces\persistence\entity\CommentBlock
    {

        /**
         * @var \KPG\Learnplaces\persistence\entity\CommentBlock $activeRecord
         */
        $activeRecord = \KPG\Learnplaces\persistence\entity\CommentBlock::where(['fk_block_id' => $commentBlock->getId()])->first();

        if(is_null($activeRecord)) {
            $activeRecord = new \KPG\Learnplaces\persistence\entity\CommentBlock();
