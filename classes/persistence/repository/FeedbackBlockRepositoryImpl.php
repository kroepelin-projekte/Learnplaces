...
class FeedbackBlockRepositoryImpl implements FeedbackBlockRepository
{
    ...
    public function findByBlockId(int $id): FeedbackBlock
    {
        try {
            ...
            $feedbackBlock = \KPG\Learnplaces\persistence\entity\FeedbackBlock::where(['fk_block_id' => $id])->first();
    ...
    public function findByLearnplace(Learnplace $learnplace): array
    {
         ...
         * @var Block[] $blocks
         */
        $blocks = Block::innerjoinAR(new \KPG\Learnplaces\persistence\entity\FeedbackBlock(), 'pk_id', 'fk_block_id')
        ...
        foreach ($blocks as $block) {
            $feedbackBlock = \KPG\Learnplaces\persistence\entity\FeedbackBlock::where(['fk_block_id' => $block->getPkId()])->first();
    ...
    private function mapToDTO(Block $block, \KPG\Learnplaces\persistence\entity\FeedbackBlock $feedbackBlockEntity): FeedbackBlock
    {
...
#			->setUserId($feedbackBlockEntity->getFkIluserId())
    ...
    private function mapToEntity(FeedbackBlock $feedbackBlock): \KPG\Learnplaces\persistence\entity\FeedbackBlock
    {

        /**
         * @var \KPG\Learnplaces\persistence\entity\FeedbackBlock $activeRecord
         */
        $activeRecord = \KPG\Learnplaces\persistence\entity\FeedbackBlock::where(['fk_block_id' => $feedbackBlock->getId()])->first();

        if(is_null($activeRecord)) {
            $activeRecord = new \KPG\Learnplaces\persistence\entity\FeedbackBlock();
