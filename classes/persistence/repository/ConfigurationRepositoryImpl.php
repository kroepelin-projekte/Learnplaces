...
class ConfigurationRepositoryImpl implements ConfigurationRepository
{
    ...
    {
        try {
            $configurationEntity = \KPG\Learnplaces\persistence\entity\Configuration::findOrFail($id);
    ...
    public function findByObjectId(int $objectId): Configuration
    {
        ...
        $configurationEntity = \KPG\Learnplaces\persistence\entity\Configuration::innerjoinAR(new Learnplace(), 'pk_id', 'fk_configuration')
    ...
    private function mapToDTO(\KPG\Learnplaces\persistence\entity\Configuration $configurationEntity): Configuration
    {
    ...
    private function mapToEntity(Configuration $configuration): \KPG\Learnplaces\persistence\entity\Configuration
    {

        /**
         * @var \KPG\Learnplaces\persistence\entity\Configuration $activeRecord
         */
        $activeRecord = new \KPG\Learnplaces\persistence\entity\Configuration($configuration->getId());
