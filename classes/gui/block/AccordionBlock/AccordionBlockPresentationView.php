 ...
 *
 * @package KPG\Learnplaces\gui\block\AccordionBlock
 *
...
final class AccordionBlockPresentationView implements Renderable
{
    ...
    public function __construct(ilLearnplacesPlugin $plugin, ilCtrl $controlFlow, ContentPresentationView $contentView)
    {
        ...
        $this->template = new ilTemplate('public/Customizing/plugins/Repository/RepositoryObject/Learnplaces/templates/default/block/tpl.accordion.html', true, true);
    }
